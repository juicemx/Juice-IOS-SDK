...
extension FuncType {
    ...
    public var gas: BigUInt {
        switch self {
        case .createStaking:
            return JuiceConfig.FuncGas.createStakingGas + rlpData.dataGasUsed()
        case .editorStaking:
            return JuiceConfig.FuncGas.editorStakingGas + rlpData.dataGasUsed()
        case .increaseStaking:
            return JuiceConfig.FuncGas.increaseStakingGas + rlpData.dataGasUsed()
        case .withdrewStaking:
            return JuiceConfig.FuncGas.withdrewStakingGas + rlpData.dataGasUsed()
        case .createDelegate:
            return JuiceConfig.FuncGas.createDelegateGas + rlpData.dataGasUsed()
        case .withdrewDelegate:
            return JuiceConfig.FuncGas.withdrewDelegateGas + rlpData.dataGasUsed()
        case .submitText:
            return JuiceConfig.FuncGas.submitTextGas + rlpData.dataGasUsed()
        case .submitVersion:
            return JuiceConfig.FuncGas.submitVersionGas + rlpData.dataGasUsed()
        case .submitParam:
            return JuiceConfig.FuncGas.submitParamGas + rlpData.dataGasUsed()
        case .submitCancel:
            return JuiceConfig.FuncGas.submitCancelGas + rlpData.dataGasUsed()
        case .voteProposal:
            return JuiceConfig.FuncGas.voteProposalGas + rlpData.dataGasUsed()
        case .declareVersion:
            return JuiceConfig.FuncGas.declareVersionGas + rlpData.dataGasUsed()
        case .reportMultiSign:
            return JuiceConfig.FuncGas.reportMultiSignGas + rlpData.dataGasUsed()
        case .createRestrictingPlan(_, let plans):
            return JuiceConfig.FuncGas.createRestrictingPlanGas + rlpData.dataGasUsed() + JuiceConfig.FuncGas.defaultGas.multiplied(by: BigUInt(plans.count))
        default:
            return JuiceConfig.FuncGas.defaultGas
        }
    }
    ...
    public var gasPrice: BigUInt? {
        switch self {
        case .submitText:
            return JuiceConfig.FuncGasPrice.submitTextGasPrice.multiplied(by: JuiceConfig.VON.GVON)
        case .submitVersion:
            return JuiceConfig.FuncGasPrice.submitVersionGasPrice.multiplied(by: JuiceConfig.VON.GVON)
        case .submitCancel:
            return JuiceConfig.FuncGasPrice.submitCancelGasPrice.multiplied(by: JuiceConfig.VON.GVON)
        case .submitParam:
            return JuiceConfig.FuncGasPrice.submitParamGasPrice.multiplied(by: JuiceConfig.VON.GVON)
        default:
            return nil
        }
    }
