...
public extension Web3.Juice {
    ...
    func Contract(json data: Data, abiKey: String?, address: String?) throws -> DynamicContract {
    ...
    func Contract(abi: [ABIObject], address: String? = nil) -> DynamicContract {
        return DynamicContract(abi: abi, address: address, juice: self)
    }
    ...
    func Contract<T: StaticContract>(type: T.Type, address: String? = nil) -> T {
        return T(address: address, juice: self)
    }
