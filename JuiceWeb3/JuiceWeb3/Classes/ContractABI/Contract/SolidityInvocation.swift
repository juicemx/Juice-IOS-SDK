...
public protocol SolidityInvocation {
    ...
    func createTransaction(nonce: EthereumQuantity?, from: String, value: EthereumQuantity?, gas: EthereumQuantity, gasPrice: EthereumQuantity?) -> EthereumTransaction?
    ...
    func send(nonce: EthereumQuantity?, from: String, value: EthereumQuantity?, gas: EthereumQuantity, gasPrice: EthereumQuantity?, completion: @escaping (EthereumData?, Error?) -> Void)
    
    /// Estimate how much gas is needed to execute this transaction.
    func estimateGas(from: String?, gas: EthereumQuantity?, value: EthereumQuantity?, completion: @escaping (EthereumQuantity?, Error?) -> Void)
...
public struct SolidityReadInvocation: SolidityInvocation {
    ...
    public func send(nonce: EthereumQuantity? = nil, from: String, value: EthereumQuantity?, gas: EthereumQuantity, gasPrice: EthereumQuantity?, completion: @escaping (EthereumData?, Error?) -> Void) {
    ...
    public func createTransaction(nonce: EthereumQuantity?, from: String, value: EthereumQuantity?, gas: EthereumQuantity, gasPrice: EthereumQuantity?) -> EthereumTransaction? {
        return nil
    }
...
public struct SolidityPayableInvocation: SolidityInvocation {
    ...
    public func createTransaction(nonce: EthereumQuantity? = nil, from: String, value: EthereumQuantity?, gas: EthereumQuantity, gasPrice: EthereumQuantity?) -> EthereumTransaction? {
        guard let data = encodeABI() else { return nil }
        guard let to = handler.address else { return nil }
        
        guard let hexFrom = try? AddrCoder.shared.decodeHex(addr: from) else { return nil }
        guard let fromAddr = try? EthereumAddress(hex: hexFrom, eip55: false) else { return nil }
        guard let hexTo = try? AddrCoder.shared.decodeHex(addr: to) else { return nil }
        guard let toAddr = try? EthereumAddress(hex: hexTo, eip55: false) else { return nil }
        return EthereumTransaction(nonce: nonce, gasPrice: gasPrice, gas: gas, from: fromAddr, to: toAddr, value: value ?? 0, data: data)
    }
...
public extension SolidityInvocation {
    ...
    func estimateGas(from: String? = nil, gas: EthereumQuantity? = nil, value: EthereumQuantity? = nil, completion: @escaping (EthereumQuantity?, Error?) -> Void) {
...
public struct SolidityConstructorInvocation {
    ...
    public func createTransaction(nonce: EthereumQuantity? = nil, from: String, value: EthereumQuantity = 0, gas: EthereumQuantity, gasPrice: EthereumQuantity?) -> EthereumTransaction? {
        guard let data = encodeABI() else { return nil }
        guard let hexFrom = try? AddrCoder.shared.decodeHex(addr: from) else { return nil }
        let fromAddr = try? EthereumAddress(hex: hexFrom, eip55: false)
        return EthereumTransaction(nonce: nonce, gasPrice: gasPrice, gas: gas, from: fromAddr, to: nil, value: value, data: data)
    }
    
    public func send(nonce: EthereumQuantity? = nil, from: String, value: EthereumQuantity = 0, gas: EthereumQuantity, gasPrice: EthereumQuantity?, completion: @escaping (EthereumData?, Error?) -> Void) {
