...
public protocol ERC20Contract: EthereumContract {
    ...
    func approve(spender: String, value: BigUInt) -> SolidityInvocation
    func allowance(owner: String, spender: String) -> SolidityInvocation
    func transferFrom(from: String, to: String, value: BigUInt) -> SolidityInvocation
    func transfer(to: String, value: BigUInt) -> SolidityInvocation
}
