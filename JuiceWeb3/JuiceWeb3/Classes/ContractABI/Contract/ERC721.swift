...
public protocol ERC721Contract: ERC165Contract {
    ...
    func balanceOf(address: String) -> SolidityInvocation
    func ownerOf(tokenId: BigUInt) -> SolidityInvocation
    func approve(to: String, tokenId: BigUInt) -> SolidityInvocation
    func getApproved(tokenId: BigUInt) -> SolidityInvocation
    func transferFrom(from: String, to: String, tokenId: BigUInt) -> SolidityInvocation
    func transfer(to: String, tokenId: BigUInt) -> SolidityInvocation
}
...
public protocol EnumeratedERC721: EthereumContract {
    ...
    func tokenOfOwnerByIndex(owner: String, index: BigUInt) -> SolidityInvocation
}
...
open class GenericERC721Contract: StaticContract, ERC721Contract {
    ...
    public required init(address: String?, juice: Web3.Juice) {
